#
# ALB Access Logging Infrastructure
#
# This file creates the S3 bucket and supporting resources for ALB access logs.
# Addresses CKV_AWS_91: ALB access logging to be configured with S3 bucket
#
...
# Versioning disabled for logs (not needed, saves cost)
...
resource "aws_s3_bucket_policy" "alb_logs" {
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      {
        Sid    = "AllowLogDeliveryServiceGetAcl"
        Effect = "Allow"
        Principal = {
          Service = "delivery.logs.amazonaws.com"
        }
