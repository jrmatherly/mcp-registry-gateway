        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Version badge */}
              {version && (
                <div className="hidden md:flex items-center px-2.5 py-1 bg-linear-to-r from-primary-500/10 to-indigo-500/10 backdrop-blur-sm rounded-lg border border-primary-500/20">
