        ...
        try {
          ...
          if (registrationType === 'server') {
            ...
            setAgentForm((prev) => ({
              ...
              path: parsed.path || prev.path,
              protocol_version:
                parsed.protocol_version || parsed.protocolVersion || prev.protocol_version,
    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        const axiosError = error as {
          response?: { data?: { detail?: string; error?: string; reason?: string } };
        };
        const message =
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setServerForm((prev) => ({ ...prev, num_tools: parseInt(e.target.value, 10) || 0 }))
            }
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setAgentForm((prev) => ({ ...prev, protocol_version: e.target.value }))
            }
            placeholder="1.0"
          />
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <p className="mt-1 text-sm text-blue-700 dark:text-blue-300">
              Upload a {registrationType === 'server' ? 'modelcard.json' : 'agentcard.json'} file to
              automatically populate the form fields. You can then review and modify the values
              before submitting.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 text-center">
          ...
          <p className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
            You do not have permission to register servers or agents. Please contact an
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Register New Service</h1>
