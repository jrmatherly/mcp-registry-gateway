  ...
  return (
    <>
      ...
      <div className="flex flex-col h-full">
        {/* Hero Banner */}
        <HeroBanner
          title="MCP Servers & A2A Agents Registry"
          subtitle="Discover, manage, and monitor all your MCP servers and Agent-to-Agent (A2A) communication endpoints."
          onRegisterClick={handleRegisterServer}
          showRegisterButton={user?.can_modify_servers || false}
        />
